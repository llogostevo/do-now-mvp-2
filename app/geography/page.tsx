        ...
        try {
            await llm.chat({
                messages: [
                    ...
                    { role: "user", content: `Subject: Geography, Level: GCSE, Specification: Pearson Edexcel Level 1/Level 2 GCSE (9-1) in Geography A (1GA0), Topic: ${topic}` },
                ],
                stream: true,
    ...
    return (
        <div className="min-h-screen mx-auto my-8 max-w-4xl px-4 sm:px-0">
            ...
            <ul className="m-5">
                ...
                <li className="p-1"><span className="font-bold">Specification</span>: Pearson Edexcel Level 1/Level 2 GCSE (9-1) in Geography A 1GA0</li>
            </ul>
